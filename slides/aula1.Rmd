...
\beginAHalfColumn
 ...
 - O R surgiu no início dos anos 90 pelas mãos de \textbf{Robert Gentleman} e \textbf{Ross Ihaka}, ambos membros do corpo docente da \textbf{Universidade de Auckland}.
...
\beginAHalfColumn
 ...
 - Hoje é possível instalar e usar o R em uma ampla variedade de plataformas UNIX e sistemas similares (incluindo FreeBSD e Linux), Windows e MacOS.
...
\beginAHalfColumn
 ...
 - É composto por \textbf{15} pacotes: `base`, `compiler`, `datasets`, `grDevices`, `graphics`, `grid`, `methods`, `parallel`, `splines`, `stats`, `stats4`, `tcltk`, `tools`, `translations` e `utils`.
...
\beginAHalfColumn
 ...
 - É composto por outros \textbf{15} pacotes: `KernSmooth`, `MASS`, `Matrix`, `boot`, `class`, `cluster`, `codetools`, `foreign`, `lattice`, `mgcv`, `nlme`, `nnet`, `rpart`, `spatial` e `survival`.
...
\beginAHalfColumn
 ...
 - A principal fonte de pactes é o próprio CRAN, que hoje conta com \textbf{mais de 19000 pacotes}.
...
## Materiais para aprender R
 ...
 - [A Student's Guide to R](http://cran-r.c3sl.ufpr.br/doc/contrib/Horton+Pruim+Kaplan_MOSAIC-StudentGuide.pdf).

 - [Using R for Data Analysis and Graphics](http://cran-r.c3sl.ufpr.br/doc/contrib/usingR.pdf).
 
 - [R for Beginners](http://cran-r.c3sl.ufpr.br/doc/contrib/Paradis-rdebuts_en.pdf).
