...
FIGURA PROGRAMAÇÃO ESTATÍSTICA
...
\begin{itemize}
\item
  O R surgiu no início dos anos 90 pelas mãos de
  \textbf{Robert Gentleman} e \textbf{Ross Ihaka}, ambos membros do
  corpo docente da \textbf{Universidade de Auckland}.
\item
...
\begin{frame}{Antes do R}
\protect\hypertarget{antes-do-r-1}{}
\beginAHalfColumn
...
\item
  Hoje é possível instalar e usar o R em uma ampla variedade de
...
\begin{frame}{O que é o R}
\protect\hypertarget{o-que-uxe9-o-r-1}{}
\beginAHalfColumn
...
\item
  É composto por \textbf{15} pacotes: \texttt{base}, \texttt{compiler},
  \texttt{datasets}, \texttt{grDevices}, \texttt{graphics},
  \texttt{grid}, \texttt{methods}, \texttt{parallel}, \texttt{splines},
  \texttt{stats}, \texttt{stats4}, \texttt{tcltk}, \texttt{tools},
  \texttt{translations} e \texttt{utils}.
\end{itemize}
...
\item
  É composto por outros \textbf{15} pacotes: \texttt{KernSmooth},
  \texttt{MASS}, \texttt{Matrix}, \texttt{boot}, \texttt{class},
  \texttt{cluster}, \texttt{codetools}, \texttt{foreign},
  \texttt{lattice}, \texttt{mgcv}, \texttt{nlme}, \texttt{nnet},
  \texttt{rpart}, \texttt{spatial} e \texttt{survival}.
\end{itemize}
...
\item
  A principal fonte de pactes é o próprio CRAN, que hoje conta com
...
\begin{itemize}
\item
  \href{https://cran.r-project.org/}{The Comprehensive R Archive
  Network}.
\item
  \href{https://posit.co/download/rstudio-desktop/}{RStudio Desktop}.
\item
  \href{https://posit.cloud/plans/free}{Posit Cloud}.
\end{itemize}
\end{frame}
...
\begin{itemize}
\item
  \href{http://cursos.leg.ufpr.br/ecr/}{Estatística Computacional com
  R}.
\item
  \href{http://www.leg.ufpr.br/~paulojus/embrapa/Rembrapa/}{Introdução
  ao Ambiente Estatístico R}.
\item
  \href{http://cran-r.c3sl.ufpr.br/doc/contrib/Horton+Pruim+Kaplan_MOSAIC-StudentGuide.pdf}{A
  Student's Guide to R}.
\item
  \href{http://cran-r.c3sl.ufpr.br/doc/contrib/usingR.pdf}{Using R for
  Data Analysis and Graphics}.
\item
  \href{http://cran-r.c3sl.ufpr.br/doc/contrib/Paradis-rdebuts_en.pdf}{R
  for Beginners}.
\end{itemize}
\end{frame}
